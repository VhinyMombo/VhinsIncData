...
```{r, echo=FALSE, message=FALSE, fig.width=9, fig.height=9, dev="png", dpi=300, fig.align='center', fig.asp=1, fig.cap="Répartition des électeurs par province"}
...
```{r, echo=FALSE, message=TRUE,  fig.width=9, fig.height=9, dev="png", dpi=300, fig.align='center', fig.asp=1, fig.cap="Répartition des électeurs par province"}
# Centroid + labels
